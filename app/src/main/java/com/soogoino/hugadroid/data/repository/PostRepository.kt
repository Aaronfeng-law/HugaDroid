package com.soogoino.hugadroid.data.repository

import android.util.Log
import androidx.core.util.AtomicFile
import com.soogoino.hugadroid.data.local.DraftDao
import com.soogoino.hugadroid.data.local.DraftEntity
import com.soogoino.hugadroid.data.local.PostDao
import com.soogoino.hugadroid.data.local.PostEntity
import com.soogoino.hugadroid.data.model.FrontMatterFormat
import com.soogoino.hugadroid.data.model.FrontMatterParser
...
import com.soogoino.hugadroid.ui.util.countWords
...
class PostRepository @Inject constructor(
    ...
    private fun PostEntity.toDomain(): HugoPost {
        ...
        return HugoPost(
            ...
            slug = slug,
            frontMatter = com.soogoino.hugadroid.data.model.HugoFrontMatter(
                title = title,
                date = date,
                draft = draft,
                tags = tagsList,
