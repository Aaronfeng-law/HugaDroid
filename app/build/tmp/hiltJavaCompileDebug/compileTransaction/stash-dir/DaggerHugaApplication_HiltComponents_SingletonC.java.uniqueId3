...
import com.soogoino.huga.ui.home.HomeViewModel;
import com.soogoino.huga.ui.home.HomeViewModel_HiltModules;
import com.soogoino.huga.ui.home.HomeViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.soogoino.huga.ui.home.HomeViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
...
public final class DaggerHugaApplication_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends HugaApplication_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.postsViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 3);
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new EditorViewModel(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), viewModelCImpl.readPostUseCase(), viewModelCImpl.savePostUseCase(), singletonCImpl.appPreferencesProvider.get());

          case 1: // com.soogoino.huga.ui.files.FilesViewModel 
          return (T) new FilesViewModel(singletonCImpl.appPreferencesProvider.get());

          case 2: // com.soogoino.huga.ui.home.HomeViewModel 
          return (T) new HomeViewModel(viewModelCImpl.observePostsUseCase(), singletonCImpl.syncRepoUseCase(), singletonCImpl.jGitRepositoryImplProvider.get(), singletonCImpl.appPreferencesProvider.get());

          case 3: // com.soogoino.huga.ui.posts.PostsViewModel 
          ...
          case 6: // com.soogoino.huga.ui.sync.SyncViewModel 
