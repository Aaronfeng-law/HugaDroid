...
public final class SecureTokenStore_Factory implements Factory<SecureTokenStore> {
  ...
  public static SecureTokenStore_Factory create(javax.inject.Provider<Context> contextProvider) {
    return new SecureTokenStore_Factory(Providers.asDaggerProvider(contextProvider));
  }
