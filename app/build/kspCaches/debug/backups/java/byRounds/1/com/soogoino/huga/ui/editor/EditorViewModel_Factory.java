...
public final class EditorViewModel_Factory implements Factory<EditorViewModel> {
  ...
  public EditorViewModel_Factory(Provider<Context> contextProvider,
      ...
      Provider<SavePostUseCase> savePostUseCaseProvider, Provider<AppPreferences> prefsProvider) {
  ...
  public EditorViewModel get() {
    return newInstance(contextProvider.get(), readPostUseCaseProvider.get(), savePostUseCaseProvider.get(), prefsProvider.get());
  }
  ...
  public static EditorViewModel_Factory create(javax.inject.Provider<Context> contextProvider,
    ...
    return new EditorViewModel_Factory(Providers.asDaggerProvider(contextProvider), Providers.asDaggerProvider(readPostUseCaseProvider), Providers.asDaggerProvider(savePostUseCaseProvider), Providers.asDaggerProvider(prefsProvider));
  }

  public static EditorViewModel_Factory create(Provider<Context> contextProvider,
      Provider<ReadPostUseCase> readPostUseCaseProvider,
      Provider<SavePostUseCase> savePostUseCaseProvider, Provider<AppPreferences> prefsProvider) {
    return new EditorViewModel_Factory(contextProvider, readPostUseCaseProvider, savePostUseCaseProvider, prefsProvider);
  }

  public static EditorViewModel newInstance(Context context, ReadPostUseCase readPostUseCase,
      SavePostUseCase savePostUseCase, AppPreferences prefs) {
    return new EditorViewModel(context, readPostUseCase, savePostUseCase, prefs);
  }
}
